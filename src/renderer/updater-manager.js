...
const UPDATE_CONFIG = globalThis.UPDATE_CONFIG || {
...
if (!globalThis.UPDATE_CONFIG) {
  globalThis.UPDATE_CONFIG = UPDATE_CONFIG;
}
...
async function installUpdateManual() {
  ...
  console.log('[Updater] Installing update manually...');
  ...
  try {
    ...
    console.error('[Updater] Install update error:', error);
...
// Show update settings (placeholder function)
function showUpdateSettings() {
  console.log('[Updater] Show update settings - not implemented');
  // TODO: Implement update settings UI
}
